  ...
  return (
    <footer className="bg-primary text-primary-foreground mt-auto">
      <div className="max-w-7xl mx-auto px-4 py-12">
            ...
            <div className="space-y-3">
              <div className="relative">
                <Input
                  ...
                  className="bg-transparent border-primary-foreground/20 placeholder:text-primary-foreground/50 focus:border-accent"
                />
        ...
        {/* Copyright Section */}
        <div className="mt-12 pt-6 border-t border-primary-foreground/20 text-center text-primary-foreground/80">
